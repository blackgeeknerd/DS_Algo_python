class Progression:
    ...
    Default iterator produces the whole number 0, 1, 2,....n
    """
...
if __name__ == '__main__':
    ...
    normal_progression = Progression()
    normal_progression.print_progression(10)
    ...
    num = 10
    arithmetic_progression.print_progression(num+1)       
    print()
    print("Geometric Progression")       
    geometric_progression = GeometricProgression()
    geometric_progression.print_progression(num)
